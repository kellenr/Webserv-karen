...
gallery_themes = {
    ...
    "fairy": {"emoji": "🧚‍♀️", "name": "Fairy Garden", "bg": "linear-gradient(135deg, #c3cfe2 0%, #c3cfe2 100%)"},
    "butterfly": {"emoji": "🦋", "name": "Butterfly Meadow", "bg": "linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%)"}
}
